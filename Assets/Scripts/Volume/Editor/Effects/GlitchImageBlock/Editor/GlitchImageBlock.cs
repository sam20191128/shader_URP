...
public class GlitchImageBlock : CustomVolumeComponent
{
    ...
    Material material;
    const string shaderName = "Hidden/PostProcessing/Glitch/ImageBlock";
    ...
    public override void Render(CommandBuffer cmd, ref RenderingData renderingData, RenderTargetIdentifier source, RenderTargetIdentifier destination)
    {
        ...
        material.SetFloat("_BlockLayer2_U", BlockLayer2_U.value);
        material.SetFloat("_BlockLayer2_V", BlockLayer2_V.value);
        material.SetFloat("_BlockLayer1_Indensity", BlockLayer1_Indensity.value);
        material.SetFloat("_BlockLayer2_Indensity", BlockLayer2_Indensity.value);
